...
public class DbInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        ServiceBooking booking1 = new ServiceBooking(customer, worker1, "AC Repair & Servicing",
                LocalDateTime.now().plusDays(1), 1500.0, "AC unit not cooling effectively and makes noise.");
        ...
        lessonRepository.save(new CourseLesson(c1.getId(), "Module 1 — Introduction to Professional Ethics",
                ...
                "Overview of customer satisfaction strategies and active listening skills.", demoVid, "12:45", 1,
                true));
        lessonRepository.save(new CourseLesson(c1.getId(), "Module 1 — Introduction to Professional Ethics",
                "Lesson 2: Client Expectation Management",
                "How to set realistic service timeframes and explain technical faults clearly.", demoVid, "15:20", 2,
                true));
        lessonRepository.save(new CourseLesson(c1.getId(), "Module 2 — Core Practical Skills",
                "Lesson 3: De-escalating Customer Complaints",
                "Practical scenarios for dealing with dissatisfied customers politely.", demoVid, "18:10", 3, false));
        lessonRepository.save(new CourseLesson(c1.getId(), "Module 2 — Core Practical Skills",
                "Lesson 4: Digital Invoicing & Service Summary",
                "Generating digital quotes and obtaining customer completion verification.", demoVid, "14:00", 4,
                false));
        lessonRepository.save(new CourseLesson(c1.getId(), "Module 3 — Masterclass Topics",
                ...
                "On-site clean-up standards and personal protection equipment.", demoVid, "10:30", 5, false));
        lessonRepository.save(new CourseLesson(c1.getId(), "Module 3 — Masterclass Topics",
                "Lesson 6: Final Evaluation & Exam Overview",
                "Prepare for final certification quiz and practical field assessment.", demoVid, "20:00", 6, false));
        ...
        lessonRepository.save(new CourseLesson(c2.getId(), "Module 1 — Inverter Technology Principles",
                "Lesson 2: PCB Microcontroller Diagnostic Codes", "Reading blink codes on outdoor unit control boards.",
        ...
        lessonRepository.save(new CourseLesson(c2.getId(), "Module 2 — Gas Charging & Leak Repair",
                ...
                "Using manifold gauges and digital scales for eco refrigerant.", demoVid, "20:30", 3, false));
        lessonRepository.save(new CourseLesson(c2.getId(), "Module 2 — Gas Charging & Leak Repair",
                "Lesson 4: Chemical Jet Foam Wash Procedure",
                "Step-by-step indoor coil cleaning without damaging blower motors.", demoVid, "15:50", 4, false));
        ...
        lessonRepository.save(new CourseLesson(c3.getId(), "Module 1 — Basic Electrical Concepts",
                ...
                "Fundamental principles of electricity for home technicians.", demoVid, "10:15", 1, true));
        lessonRepository.save(new CourseLesson(c3.getId(), "Module 1 — Basic Electrical Concepts",
                "Lesson 2: Safety Gear & Multimeter Usage", "How to use a digital multimeter without short circuiting.",
        ...
        lessonRepository.save(
                new CourseLesson(c3.getId(), "Module 2 — House Wiring Basics", "Lesson 4: Earthing & Shock Prevention",
                        "Step by step earthing rod installation and resistance check.", demoVid, "16:45", 4, true));
        lessonRepository.save(
                new CourseLesson(c3.getId(), "Module 3 — Summary", "Lesson 5: Emergency First Aid & Shock Response",
                        "Crucial first-aid steps in case of electrical accidents.", demoVid, "11:20", 5, true));
        ...
        lessonRepository.save(new CourseLesson(c4.getId(), "Module 1 — Concealed Leak Detection",
                ...
                "Using ultrasonic listening devices to locate water wall leaks.", demoVid, "13:20", 1, true));
        lessonRepository.save(new CourseLesson(c4.getId(), "Module 1 — Concealed Leak Detection",
                "Lesson 2: CPVC Pipe Heat Fusion Joining",
                "Proper heating temperature and socket depth for CPVC joints.", demoVid, "17:10", 2, true));
        lessonRepository.save(
                new CourseLesson(c4.getId(), "Module 2 — Hydrostatic Testing", "Lesson 3: High Pressure Pump Testing",
                        "Testing pipeline integrity at 10 bar pressure before tiling.", demoVid, "19:00", 3, false));

        // Course 5 Lessons
        lessonRepository.save(new CourseLesson(c5.getId(), "Module 1 — Smart Relays",
                "Lesson 1: Neutral vs Non-Neutral Switch Wiring",
                "Wiring Tuya & Sonoff smart relays into standard electrical gang boxes.", demoVid, "15:00", 1, true));
        lessonRepository.save(new CourseLesson(c5.getId(), "Module 2 — Zigbee Mesh Setup",
                "Lesson 2: Zigbee 3.0 Gateway Pairing",
                "Connecting wireless motion sensors & door contacts to Home Assistant.", demoVid, "18:40", 2, false));
        ...
        lessonRepository.save(new CourseLesson(c6.getId(), "Module 1 — Hazard Identification",
                ...
                "Understanding personal protective equipment (PPE) ratings.", demoVid, "11:30", 1, true));
        lessonRepository.save(
                new CourseLesson(c6.getId(), "Module 2 — LOTO Safety", "Lesson 2: Lockout / Tagout (LOTO) Procedures",
                        "Securing power breakers during site service work.", demoVid, "14:15", 2, true));

        // Course 7 Lessons
        lessonRepository.save(
                new CourseLesson(c7.getId(), "Module 1 — Wall Preparation", "Lesson 1: Dampproof Barrier Application",
                        "Sealing damp brick walls with waterproof acrylic polymer.", demoVid, "16:20", 1, true));
        ...
        lessonRepository.save(new CourseLesson(c8.getId(), "Module 2 — Inverter Wiring",
                ...
                "Connecting solar panels, utility grid, and battery storage.", demoVid, "24:30", 2, false));

        // Course 9 Lessons
        lessonRepository.save(new CourseLesson(c9.getId(), "Module 1 — Refrigeration Cycle",
                "Lesson 1: Compressor Replacement & Brazing", "Removing burnt out fridge compressors safely.", demoVid,
                "18:15", 1, true));
        ...
        lessonRepository.save(new CourseLesson(c11.getId(), "Module 1 — Diesel Engine Tune-Up",
                ...
                "Changing oil filters, fuel filters, and bleeding fuel injectors.", demoVid, "22:10", 1, true));

        // Course 12 Lessons (Free CCTV Course)
        lessonRepository.save(
                new CourseLesson(c12.getId(), "Module 1 — IP Networking", "Lesson 1: Cat6 Cable Crimping & PoE Testing",
                        "Crimping RJ45 connectors with standard T568B pinout.", demoVid, "12:00", 1, true));
        lessonRepository.save(
                new CourseLesson(c12.getId(), "Module 2 — NVR Configuration", "Lesson 2: NVR Remote Cloud App Setup",
                        "Pairing IP cameras to mobile smartphones via P2P cloud barcode.", demoVid, "16:30", 2, true));
        ...
        marketplaceRepository.save(new MarketplaceItem("Industrial Pipe Wrench Set",
                "Durable heavy-duty wrench set, sizes 10, 14, and 18 inches.", 1550.0, "TOOL",
                "https://images.unsplash.com/photo-1586864387967-d02ef85d93e8?w=200&auto=format&fit=crop"));
        marketplaceRepository.save(new MarketplaceItem("AC Gas Charger Manifold Gauge",
                "Double valve manifold gauge with hose pipes for R22 and R410 refrigerant.", 2800.0, "TOOL",
                "https://images.unsplash.com/photo-1581092160607-ee22621dd758?w=200&auto=format&fit=crop"));
        marketplaceRepository.save(new MarketplaceItem("Submersible Water Pump Motor (1.5 HP)",
                "High efficiency copper winding motor with thermal overload protector.", 12500.0, "SPARE_PART",
                "https://images.unsplash.com/photo-1508962914676-134849a727f0?w=200&auto=format&fit=crop"));
        marketplaceRepository.save(new MarketplaceItem("Heavy Duty Demolition Jack Hammer (Rental)",
                "Rent per day: Professional grade concrete and rock breaker.", 800.0, "RENTAL",
                "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=200&auto=format&fit=crop"));
